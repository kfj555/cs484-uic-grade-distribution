...
const GraphAllYearsBody = ({ data }: { data: Course[] }) => {
      ...
      {chartData.map((cData, index) => {
        ...
        return (
          <div key={index} className="border mx-3 p-3">
            <h3 className="text-center font-semibold mb-2">{`${seasonMap[data[index].season]} ${data[index].year}`}</h3>
...
export default GraphAllYearsBody;
